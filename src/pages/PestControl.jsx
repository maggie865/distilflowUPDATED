      ...
      <Tabs defaultValue="map">
        ...
        <TabsContent value="map">
          <Card className="p-4">
            ...
            {/* Map area */}
            <div
              className="relative w-full bg-muted/30 border border-border rounded-xl overflow-hidden cursor-crosshair"
              style={{ height: '400px' }}
              onClick={handleMapClick}
            >
              <div className="absolute inset-0 flex items-center justify-center text-muted-foreground/20 text-sm font-medium pointer-events-none">
                {traps.length === 0 ? 'Add traps and drag them to their locations' : 'Your facility floor plan'}
              </div>
